...
<body class="bg-light">
  ...
  <main>
    ...
    <div class="container">
      <h1>Welcome to Loan Market </h1>
      <h2>Here you can compare the Loan offerings of different firms</h2>
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
             <b> <h4 class="card-title">${product.name}</h4></b>
              ...
              <form action="/getDetails/${product.id}" method="get">
                <input type="hidden" name="id" value="${product.id}">
              	<input type="submit" value="Get Details" class="btn btn-warning">
              </form>
            </div>
          </div>
        </div> </c:forEach>

    ...
    <div class="col-sm-6">
        ...
        <form action="newuserregister" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="age" id="age" required placeholder="age" required class="form-control form-control-lg">
            </div>
            <div class="form-group">
                <label for="Salary">Salary</label>
                <select class="form-control form-control-lg" name="salary">
                     <option value="30">Below 30K </option>
                     <option value="35">30-40K</option>
                     <option value="45">40-50K</option>
                     <option value="55">Above 50K</option>
                </select>
            </div>
            <div class="form-group">
                <label for="creditScore">Credit Score</label>
                <input type="text" name="creditScore" id="creditScore" required placeholder="Credit Score" required class="form-control form-control-lg">
            </div>
